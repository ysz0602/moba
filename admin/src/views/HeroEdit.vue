        ...
        <el-tab-pane label="基础信息" name="basic">
          ...
          <el-form-item label="类型">
            <el-select v-model="model.categories" multiple>
              <el-option v-for="(item, i) of categories"
                :key="i"
                :label="item.name"
                :value="item._id"
              >
          ...
          <el-form-item label="顺风出装">
            <el-select v-model="model.items1" multiple>
              <el-option v-for="(item, i) of items"
                :key="i"
                :label="item.name"
                :value="item._id"
              >
...
export default {
  ...
  methods: {
    async save() {
      await this.id ? this.$http.put(`/rest/heroes/${this.id}`, this.model) : this.$http.post('/rest/heroes', this.model)
